...
@Configuration
@ConfigurationProperties(prefix = "relation-model-build")
@PropertySource(value = "classpath:relation-model-build.yml", factory = YamlPropertySourceFactory.class)
@Getter
@Setter
public class RelationModelBuildProperties {
